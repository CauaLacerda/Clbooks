  ...
  <header>
    <nav class="navbar navbar-expand-lg fundo-azul fixed-top">
      <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('app') }}"><img src="{{url('/')}}/imagens/Logo-projeto.png" width="110"
            alt="logo empresa" /></a>
  ...
  <main class="main-cl pt-3">
    ...
    <div id="imagem-carousel" class="carousel slide d-none d-lg-block" data-bs-ride="carousel">
      <ol class="carousel-indicators">
        <li data-bs-target="#imagem-carousel" data-bs-slide-to="0" class="active" aria-current="true"
